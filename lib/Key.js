...
class Key {
  ...
  constructor (publicKey, privateKey, seed) {
    ...
    // private properties
    const _encodedPublicKey = KeyCodec.encodePublicKey(publicKey);
    const _encodedPrivateKey = KeyCodec.encodePrivateKey(privateKey, seed);
     ...
     * @returns {Uint8Array}
     */
    this.getEncodedPublicKey = () => _encodedPublicKey.slice();

    /**
     * @returns {Uint8Array}
     */
    this.getPrivateKey = () => privateKey.slice();

    /**
     * @returns {Uint8Array}
     */
    this.getEncodedPrivateKey = () => _encodedPrivateKey.slice();

    /**
     * @returns {Uint8Array}
     */
    this.getSeed = () => seed.slice();
  }
