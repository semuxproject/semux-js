...
describe("Transaction", () => {
  ...
  TEST_TX.signature = Buffer.from("3a2948cbf99a5d833176139c9a66279389e8e8c71eec242826922e07e3c92882929afb82ce3048ec21310d5fe295e674587cd0197da6250542fc839a546d1b0db72dc8ebc9f53d21837dc96483da08765ea11f25c1bd4c3cb49318c944d67b9b", "hex");

  function assertTestTx(tx) {
  ...
  it("de-serializes a serialized transaction", () => {
    const tx = Transaction.fromBytes(TEST_TX.serialized);
    assertTestTx(tx);
    Assert.deepEqual(tx.getSignature().getPublicKey(), TEST_TX.key.getPublicKey());
    Assert.deepEqual(tx.getSignature().toBytes(), TEST_TX.signature);
  });
});