...
export interface LogInfoType {
    /**
     * Address encoded in hexadecimal string
     * @type {string}
     * @memberof LogInfoType
     */
    address?: string;
    /**
     * Log info data encoded in hexadecimal string
     * @type {string}
     * @memberof LogInfoType
     */
    data?: string;
    /**
     * Topics encoded in hexadecimal string
     * @type {Array&lt;string&gt;}
     * @memberof LogInfoType
     */
    topics?: Array<string>;
...
export const SemuxApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        call(from: string, to: string, value: string, gasPrice: string, gas: string, nonce?: string, validateNonce?: boolean, data?: string, local?: boolean, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        composeRawTransaction(network: 'MAINNET' | 'TESTNET' | 'DEVNET', type: 'TRANSFER' | 'DELEGATE' | 'VOTE' | 'UNVOTE', fee: string, nonce: string, to?: string, value?: string, timestamp?: string, data?: string, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        create(from: string, data: string, gasPrice: string, gas: string, nonce?: string, validateNonce?: boolean, options: any = {}): FetchArgs {
            // verify required parameter 'from' is not null or undefined
            if (from === null || from === undefined) {
...
export const SemuxApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        call(from: string, to: string, value: string, gasPrice: string, gas: string, nonce?: string, validateNonce?: boolean, data?: string, local?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DoTransactionResponse> {
            const localVarFetchArgs = SemuxApiFetchParamCreator(configuration).call(from, to, value, gasPrice, gas, nonce, validateNonce, data, local, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        composeRawTransaction(network: 'MAINNET' | 'TESTNET' | 'DEVNET', type: 'TRANSFER' | 'DELEGATE' | 'VOTE' | 'UNVOTE', fee: string, nonce: string, to?: string, value?: string, timestamp?: string, data?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ComposeRawTransactionResponse> {
         ...
         * @throws {RequiredError}
         */
        create(from: string, data: string, gasPrice: string, gas: string, nonce?: string, validateNonce?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DoTransactionResponse> {
            const localVarFetchArgs = SemuxApiFetchParamCreator(configuration).create(from, data, gasPrice, gas, nonce, validateNonce, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const SemuxApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        call(from: string, to: string, value: string, gasPrice: string, gas: string, nonce?: string, validateNonce?: boolean, data?: string, local?: boolean, options?: any) {
            return SemuxApiFp(configuration).call(from, to, value, gasPrice, gas, nonce, validateNonce, data, local, options)(fetch, basePath);
        },
        /**
         * Compose an unsigned raw transaction then return its hexadecimal encoded string. An unsigned raw transaction can be signed using /sign-raw-transaction API.
         * @summary Compose an unsigned raw transaction
         ...
         * @throws {RequiredError}
         */
        composeRawTransaction(network: 'MAINNET' | 'TESTNET' | 'DEVNET', type: 'TRANSFER' | 'DELEGATE' | 'VOTE' | 'UNVOTE', fee: string, nonce: string, to?: string, value?: string, timestamp?: string, data?: string, options?: any) {
         ...
         * @throws {RequiredError}
         */
        create(from: string, data: string, gasPrice: string, gas: string, nonce?: string, validateNonce?: boolean, options?: any) {
            return SemuxApiFp(configuration).create(from, data, gasPrice, gas, nonce, validateNonce, options)(fetch, basePath);
        },
        /**
         * Creates a new account by generating a new private key or importing an existing private key when parameter 'privateKey' is provided.
         * @summary Create or import an account
...
export class SemuxApi extends BaseAPI {
     ...
     * @memberof SemuxApi
     */
    public call(from: string, to: string, value: string, gasPrice: string, gas: string, nonce?: string, validateNonce?: boolean, data?: string, local?: boolean, options?: any) {
     ...
     * @memberof SemuxApi
     */
    public composeRawTransaction(network: 'MAINNET' | 'TESTNET' | 'DEVNET', type: 'TRANSFER' | 'DELEGATE' | 'VOTE' | 'UNVOTE', fee: string, nonce: string, to?: string, value?: string, timestamp?: string, data?: string, options?: any) {
     ...
     * @memberof SemuxApi
     */
    public create(from: string, data: string, gasPrice: string, gas: string, nonce?: string, validateNonce?: boolean, options?: any) {
