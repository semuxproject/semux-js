...
export default class Transaction {
    ...
    private signature;
    constructor(network: Network, type: TransactionType, to: Uint8Array, value: Long, fee: Long, nonce: Long, timestamp: Long, data: Uint8Array, hash?: Uint8Array, signature?: Signature);
    getNetworkId(): number;
    getNetwork(): Network;
